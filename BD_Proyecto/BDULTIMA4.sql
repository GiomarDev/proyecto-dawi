...
INSERT INTO `tb_enlace` VALUES (1,'InformeMultiple','informemultiple.jsp'),(2,'PlanTrabajo','plantrabajo.jsp'),(3,'UnidadOrganica','unidadorganica.jsp'),(4,'FormatoRai','consultaformatorai.jsp'),(5,'FormatoRai2','formatorai.jsp');
...
INSERT INTO `tb_informerai` VALUES (1,'Tecnologia','Consejo','Importante',1,1),(2,'Importante','Pereodico','Tecnologia',1,1),(3,'Importante','Consejo','Importante',1,1);
...
INSERT INTO `tb_plantrabajo` VALUES (1,'Tecnologia','Tecnologia','2020-10-10','2020-11-11','2 Mouses','Todo conforme');
...
INSERT INTO `tb_rol_enlace` VALUES (1,1),(2,1),(3,1),(4,1),(5,1);
...
INSERT INTO `tb_unidadorganica` VALUES (1,'Giomar','Limo','giomar@gmail.com','administrador');
...
--
/*!50003 DROP PROCEDURE IF EXISTS `sp_consultaOrganica` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_consultaOrganica`()
BEGIN

select p.cod_uniO, nom_uniO from tb_unidadorganica p;
...
/*!50003 DROP PROCEDURE IF EXISTS `sp_consulta_formato_rai` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_consulta_formato_rai`()
BEGIN

select p.cod_infor, p.descripcion, p.fuentes, p.contenido, a.area_planT, e.ape_usr 
from tb_informerai p join tb_usuario e
on e.cod_usr= p.cod_usr join tb_plantrabajo a on a.cod_planT = p.cod_planT;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_consulta_trabajo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_consulta_trabajo`()
BEGIN
select t.cod_planT, t.area_planT from tb_plantrabajo t;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_eliminarFormato` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_eliminarFormato`(id int)
BEGIN

delete from tb_informerai where cod_infor=id;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_insertar_formato` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insertar_formato`(descr varchar(45), fue varchar(45), conte varchar(45), cod_plan int, cod_usr int)
BEGIN

insert into tb_informerai values(null, descr, fue, conte, cod_plan, cod_usr);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_update_formato` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_formato`(id int, des varchar(25),fue varchar(25), cont varchar(25), codPlan int, codUsr int)
BEGIN

	update tb_informerai set descripcion=des,fuentes=fue,contenido=cont,
								cod_planT=codPlan,
                                cod_usr=codUsr
                                where cod_infor=id;
...
-- Dump completed on 2020-12-07  2:51:19

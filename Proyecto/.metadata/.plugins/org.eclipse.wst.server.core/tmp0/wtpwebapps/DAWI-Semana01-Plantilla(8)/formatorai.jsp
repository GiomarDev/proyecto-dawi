				...
				<div class="modal-body" style="padding: 20px 20px;">
					<form id="idRegistra" accept-charset="UTF-8" action="saveFormato" 
		                                	...
		                                	<div class="form-group">
												...
												<input class="form-control" id="idNombre" name="formato.descip" placeholder="Ingrese  Descripcion"/>
			                                </div>    
		                                    <div class="form-row">
			                                    <div class="form-group col-md-6">
			                                        <label for="staticEmail">Fuentes</label>
														<input class="form-control" id="idFuentes" name="formato.fuentes" placeholder="Ingrese Fuentes"/>
			                                    </div>
			                                    <div class="form-group col-md-6">
			                                        <label for="staticEmail">Contenido</label>
														<input class="form-control" id="idContenido" name="formato.contenido" placeholder="Ingrese Contenido"/>
			                                    </div>
			                                	<div class="form-group col-md-6">
		                                    ...
		                                    <div class="form-group">
		                                        <label for="staticEmail">Plan de Trabajo</label>
                ...
                Precio: {
                    ...
                    validators: {    
                        ...
                        regexp: {    
                            ...
                            message: 'Campo número de precio invalido Ejem: 200.00'    
                        },   
                    }    
                },      				
                Distrito: {
